...
public class ExecutorConfig {
    ...
    @Value("${async.executor.thread.pool.core_pool_size:3}")
    private int corePoolSize;
    @Value("${async.executor.thread.pool.max_pool_size:8}")
    private int maxPoolSize;
    @Value("${async.executor.thread.pool.queue_capacity:100}")
    private int queueCapacity;
    @Value("${async.executor.thread.pool.name.prefix:async-handler-}")
